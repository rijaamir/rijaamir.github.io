...
lib.ssMetadata = [
		{name:"bounceinteractive_atlas_1", frames: [[0,0,862,1754]]}
];
...
(lib.chromesearch___localntp_localntphtmliPhone6_7_81 = function() {
	this.initialize(ss["bounceinteractive_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.bounceinteractive = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.shape.setTransform(400,475);
...
// library properties:
lib.properties = {
	id: '62A0B73A988A70439232F69695A6E767',
	width: 800,
	height: 600,
	fps: 24,
	color: "#464777",
...
an.compositions['62A0B73A988A70439232F69695A6E767'] = {
